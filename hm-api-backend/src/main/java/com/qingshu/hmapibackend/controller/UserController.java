...
import com.qingshu.hmapibackend.config.EmailConfig;
...
import static com.qingshu.hmapibackend.constant.EmailConstant.*;
import static com.qingshu.hmapibackend.constant.UserConstant.ADMIN_ROLE;
import static com.qingshu.hmapibackend.utils.EmailUtil.buildEmailContent;
...
public class UserController {
    ...
    public BaseResponse<Boolean> getCaptcha(String emailAccount) {
        ...
        // 邮箱格式校验 正则表达式,要求邮箱格式必须正确，邮箱名只能由数字、字母、下划线、点号、加号、减号组成，长度为6-18位
