package com.qingshu.hmapibackend.service;
...
class UserServiceTest {
    ...
    @Test
    void invoke() {
        InterfaceInfo interfaceInfo = interfaceInfoService.getById(1706657106238844930L);

        User user = userService.getById(1707279678647242753L);
        UserVO userVO = new UserVO();
        BeanUtils.copyProperties(user, userVO);
        // userVO.setBalance(0);
        // userVO.setStatus(UserAccountStatusEnum.BAN.getValue());
        com.qingshu.hmapicommon.model.entity.InterfaceInfo newInterfaceInfo = new com.qingshu.hmapicommon.model.entity.InterfaceInfo();
    ...
    void pay() {
        ...
        // request.setNotifyUrl("https://qingshu.icu/");
